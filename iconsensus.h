...
public:
	...
	virtual uint64_t locateSynchronizedRoot(std::multimap<uint32_t /*latency*/, IPeerPtr>& /*peers*/, uint256& /*block*/, uint256& /*last*/) { throw qbit::exception("NOT_IMPL", "IConsensus::locateSynchronizedRoot - not implemented."); }
	...
	virtual bool checkSequenceConsistency(const BlockHeader& /*block*/, bool& /*extended*/, bool lazy = false) { throw qbit::exception("NOT_IMPL", "IConsensus::checkSequenceConsistency - not implemented."); }
