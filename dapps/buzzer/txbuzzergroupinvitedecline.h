...
#ifndef QBIT_TXBUZZER_GROUP_INVITE_DECLINE_H
#define QBIT_TXBUZZER_GROUP_INVITE_DECLINE_H

#include "txbuzzer.h"

#define TX_BUZZER_GROUP_INVITE_DECLINE_MY_IN 0
#define TX_BUZZER_GROUP_INVITE_DECLINE_IN 1

namespace qbit {

//
class TxBuzzerGroupInviteDecline: public TxBuzzerGroupInvite {
public:
	TxBuzzerGroupInviteDecline() { type_ = TX_BUZZER_GROUP_INVITE_DECLINE; }

	inline std::string name() { return "buzzer_group_invite_decline"; }
...
typedef std::shared_ptr<TxBuzzerGroupInviteDecline> TxBuzzerGroupInviteDeclinePtr;

class TxBuzzerGroupInviteDeclineCreator: public TransactionCreator {
public:
	TxBuzzerGroupInviteDeclineCreator() {}
	TransactionPtr create() { return std::make_shared<TxBuzzerGroupInviteDecline>(); }

	static TransactionCreatorPtr instance() { return std::make_shared<TxBuzzerGroupInviteDeclineCreator>(); }
};
