...
#ifndef QBIT_TXBUZZER_MISTRUST_H
#define QBIT_TXBUZZER_MISTRUST_H
...
//
#define TX_BUZZER_MISTRUST_MY_IN 0
#define TX_BUZZER_MISTRUST_BUZZER_IN 1
#define TX_BUZZER_MISTRUST_FEE_IN 2

#define TX_BUZZER_MISTRUST_FEE_LOCKED_OUT 1

//
class TxBuzzerMistrust: public TxEvent {
public:
	TxBuzzerMistrust() { type_ = TX_BUZZER_MISTRUST; }
	...
	inline std::string name() { return "buzzer_mistrust"; }
	...
	static inline bool extractLockedAmountAndHeight(TxFeePtr fee, amount_t& amount, uint64_t& height) {
		//
		Transaction::Out& lOut = fee->out()[TX_BUZZER_MISTRUST_FEE_LOCKED_OUT];
...
typedef std::shared_ptr<TxBuzzerMistrust> TxBuzzerMistrustPtr;

class TxBuzzerMistrustCreator: public TransactionCreator {
public:
	TxBuzzerMistrustCreator() {}
	TransactionPtr create() { return std::make_shared<TxBuzzerMistrust>(); }

	static TransactionCreatorPtr instance() { return std::make_shared<TxBuzzerMistrustCreator>(); }
};
