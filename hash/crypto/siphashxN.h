...
inline void siphash24x4(const siphash_keys *keys, const uint64_t *indices, uint64_t *hashes) {
...
inline void siphash24x2(const siphash_keys *keys, const uint64_t *indices, uint64_t *hashes) {
...
inline void siphash24xN(const siphash_keys *keys, const uint64_t *indices, uint64_t * hashes) {
#if NSIPHASH == 1
