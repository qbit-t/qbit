...
#ifndef INCLUDE_CUCKATOO_H
#define INCLUDE_CUCKATOO_H
...
inline word_t sipnode(siphash_keys *keys, word_t edge, u32 uorv) {
...
inline int verify(word_t edges[PROOFSIZE], siphash_keys *keys) {
