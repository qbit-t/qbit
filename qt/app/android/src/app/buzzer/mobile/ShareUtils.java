...
public class ShareUtils
{
	...
	private static String AUTHORITY="app.buzzer.mobile.fileprovider";
    ...
    public static boolean sendFile(String filePath, String title, String mimeType, int requestId) {
		...
		if (requestId > 0) QtNative.activity().startActivityForResult(Intent.createChooser(sendIntent, null), requestId);
		else QtNative.activity().startActivity(Intent.createChooser(sendIntent, null));
    ...
    public static boolean viewFile(String filePath, String title, String mimeType, int requestId) {
		...
		if (requestId > 0) QtNative.activity().startActivityForResult(Intent.createChooser(viewIntent, null), requestId);
		else QtNative.activity().startActivity(Intent.createChooser(viewIntent, null));
