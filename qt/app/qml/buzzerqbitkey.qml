...
QuarkPage
{
	...
	Flickable {
		...
		Rectangle {
			...
			height: buzzerqbitkey_.height - (y + toolBar.height + (buzzerqbitkey_.showKeys ? 0 : linkButton.height + nameEditBox.height) + bottomOffset + 15 + (buzzerqbitkey_.showKeys ? 0 : 15 + 10)) < 180 ?
						180 :
						buzzerqbitkey_.height - (y + toolBar.height + (buzzerqbitkey_.showKeys ? 0 : linkButton.height + nameEditBox.height) + bottomOffset + 15 + (buzzerqbitkey_.showKeys ? 0 : 15 + 10))
