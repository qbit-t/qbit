...
QuarkPage
{
	...
	Image {
		...
		width: (parent.width - 200) > 400 ? 400 : (parent.width - 200)
		height: (switchBox.y - (welcomeText.y + welcomeText.height + 30)) - 30
	...
	QuarkButton {
		...
		onClicked: {
			...
			if (!switchBox.checked) {
				lComponent = Qt.createComponent("qrc:/qml/setupqbitaddress-desktop.qml");
