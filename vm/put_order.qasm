...
- подписанные концы будут снабжены микропрограммой, которая не позволит их использовать для броадкаст-транзакций, таки концы могут только быть использованы при формировании транзакции защищённым кодом (на нескольких узлах, дублирующих активный - они должны получить тот же результат с таким-же производными транзакциями, что и основной)
