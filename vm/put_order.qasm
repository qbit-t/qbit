...
- биткоин-миррор транзакция от пользователя, пользователю с нарезкой по лотам и подготовка подписанных входов для каждого заготовленного выхода с таймлоком >= 3;
- биткоин-рескью транзакция от пользователя, пользователю с таймлоком 0
- ордер-лот транзакция, от пользователя, пользователю с нарезкой qbtc на лоты
- ордер-контракт с метаинформацией о биткоин-миррор, биткоин-рескью и ордер-лот тразакциях
*/